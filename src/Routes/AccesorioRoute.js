...
router.post("/",upload.single("imagenPrincipal"),AccesorioController.crearAccesorio);
router.get("/", AccesorioController.obtenerAccesorios);
router.get("/byId/:id", AccesorioController.obtenerAccesorioById);
router.put("/editarAccesorio/:id",upload.single("imagenPrincipal"),AccesorioController.editarAccesorio);
